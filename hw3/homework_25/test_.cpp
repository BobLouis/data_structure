...
public:
    ...
    void del_nodeFromLeaf(int idx);

    // A function to remove the key present in idx-th position in
    // this node which is a non-leaf node
    void del_nodeFromNonLeaf(int idx);
...
public:
    ...
    // The main function that del_nodes a new key in thie B-Tree
    void del_node(int k);

    //return the val of the given rank
...
void BTreeNode::del_nodeFromLeaf(int idx)
{
...
void BTreeNode::del_nodeFromNonLeaf(int idx)
{
